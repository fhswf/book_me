...
export const markdownComponents: Components = {
    ...
    a: ({ node, children, ...props }) => <a className="text-primary font-medium hover:underline underline-offset-4" {...props}>{children}</a>,
    ul: ({ node, children, ...props }) => <ul className="list-disc list-inside mb-4 pl-4 text-muted-foreground" {...props}>{children}</ul>,
