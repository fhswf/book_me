...
import { faSignInAlt, faUserPlus, faEnvelope, faLock,faSpinner,faCalendar } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="login">
      ...
      <div className="calIcon" onClick={onIconClick} >
        ...
        <Form onSubmit={handleOnSubmit}>
          ...
          <Button variant="info" as={Link} to="/register" role="button" target="_self">
